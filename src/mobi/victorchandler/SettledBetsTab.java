...
import mobi.victorchandler.task.GetSettledBetsTask;
...
/**
 * Settled Bets List Tab inside Statements.
 * 
 * @author riveram
 *
 */
public class SettledBetsTab extends ExpandableListActivity {
    ...
    private void setUpTask() {
        ...
        if (!nh.isNetworkAvailable()) {
            ...
            new GetSettledBetsTask(this).execute();
        }
